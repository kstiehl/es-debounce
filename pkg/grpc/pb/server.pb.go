...
type RecordResponseCode int32

const (
	RecordResponseCode_RECORD_OK RecordResponseCode = 0
)

// Enum value maps for RecordResponseCode.
var (
	RecordResponseCode_name = map[int32]string{
		0: "RECORD_OK",
	}
	RecordResponseCode_value = map[string]int32{
		"RECORD_OK": 0,
	}
)

func (x RecordResponseCode) Enum() *RecordResponseCode {
	p := new(RecordResponseCode)
	*p = x
	return p
}

func (x RecordResponseCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RecordResponseCode) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_server_proto_enumTypes[0].Descriptor()
}

func (RecordResponseCode) Type() protoreflect.EnumType {
	return &file_proto_server_proto_enumTypes[0]
}

func (x RecordResponseCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RecordResponseCode.Descriptor instead.
func (RecordResponseCode) EnumDescriptor() ([]byte, []int) {
...
func (x *RecordEventRequest) GetObjectID() string {
	if x != nil {
		return x.ObjectID
	}
	return ""
...
func (x *RecordEventRequest) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
type RecordEventResponse struct {
	...
	Code RecordResponseCode `protobuf:"varint,1,opt,name=code,proto3,enum=RecordResponseCode" json:"code,omitempty"`
}
...
func (x *RecordEventResponse) GetCode() RecordResponseCode {
	if x != nil {
		return x.Code
	}
	return RecordResponseCode_RECORD_OK
}
...
var file_proto_server_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5e, 0x0a, 0x12, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x45, 0x76,
	...
	0x6e, 0x74, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x44,
	...
	,
...
var file_proto_server_proto_goTypes = []interface{}{
	(RecordResponseCode)(0),     // 0: RecordResponseCode
	(*RecordEventRequest)(nil),  // 1: RecordEventRequest
	(*RecordEventResponse)(nil), // 2: RecordEventResponse
}
var file_proto_server_proto_depIdxs = []int32{
	0, // 0: RecordEventResponse.code:type_name -> RecordResponseCode
	1, // 1: RecordingService.RecordEvent:input_type -> RecordEventRequest
	2, // 2: RecordingService.RecordEvent:output_type -> RecordEventResponse
